...
public class OpenGLRender implements GLSurfaceView.Renderer {
	private FloatBuffer triangleVB, rectVB;
	public float mAngle;
...
//        gl.glRotatef(angle, 0.0f, 0.0f, 1.0f); 
		...
		gl.glColor4f(0.63671875f, 0.76953125f, 0.22265625f, 0.0f);
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, rectVB);
		gl.glDrawArrays(GL10.GL_TRIANGLES, 0, 3);
    }
    ...
    private void initShapes(){
        ...
        rectVB = vbb2.asFloatBuffer();  // create a floating point buffer from the ByteBuffer
        rectVB.put(rectangleCoords);    // add the coordinates to the FloatBuffer
        rectVB.position(0);            // set the buffer to read the first coordinate
